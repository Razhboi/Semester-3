...
public class InventorySystem {
    private static final String TEXT_FILE = "produk.txt"; // Nama file teks
    private static final String SERIAL_FILE = "produk.ser"; // Nama file serial
    private static List<Produk> produkList = new ArrayList<>(); // List untuk menyimpan produk
    ...
    // Simpan daftar produk ke file teks
    ...
    // Simpan daftar produk ke file serial
